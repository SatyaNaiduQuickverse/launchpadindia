     ...
     <div className="max-w-7xl mx-auto px-4 py-8">
       ...
       <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
         ...
         <Card 
           ...
           onClick={() => navigate('/admin/paid-submissions')}
         >
           <CardContent className="p-6">
             <div className="flex items-center justify-between">
               <div>
                 <p className="text-sm text-muted-foreground">Paid Submissions</p>
                 <p className="text-3xl font-bold">{stats.paid_submissions || 0}</p>
                 <p className="text-xs text-slate-500">₹{(stats.revenue || 0).toLocaleString()}</p>
               </div>
